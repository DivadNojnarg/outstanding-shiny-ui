...
This book is organized into six parts. 
  ...
  - Part 3 focuses on CSS and SASS, showcasing examples from the R community like `{fresh}` [@R-fresh] and `{bootstraplib}` [@R-bootstraplib], to beautify apps with only few lines of code
