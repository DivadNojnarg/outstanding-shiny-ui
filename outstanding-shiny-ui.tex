...
\NormalTok{  .}\AttributeTok{attr}\NormalTok{(}\StringTok{'id'}\OperatorTok{,} \StringTok{'myAwesomeItem'}\NormalTok{)}\OperatorTok{;} \CommentTok{// add an id attribute}
\NormalTok{  .}\AttributeTok{fadeIn}\NormalTok{(}\DecValTok{500}\NormalTok{)}\OperatorTok{;} \CommentTok{// add animation}
\end{Highlighting}
\end{Shaded}
