...
In rare cases, you may need to remove an existing dependency (conflict). The \texttt{suppressDependencies} allows to perform that task. \href{https://github.com/Appsilon/shiny.semantic}{shiny.semantic} built on top of
...
\begin{Highlighting}[]
\KeywordTok{shinyApp}\NormalTok{(}
  \DataTypeTok{ui =} \KeywordTok{tagList}\NormalTok{(}
