...
`{bslib}` [@R-bslib] is a package developed by RStudio, built on top `{sass}` providing weapons to deeply customize your apps, in a ridiculously short amount of time and without too much pain, as shown on Figure \@ref(fig:bslib-motivations).
