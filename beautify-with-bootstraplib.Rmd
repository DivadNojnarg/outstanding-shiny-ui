...
Figure \@ref(fig:bslib-bootstrap-accordions) shows the expected output for Bootstrap 4 and 5. Solutions may be found in appendix \@ref(bslib-bootstrap-accordion-appendix). 
