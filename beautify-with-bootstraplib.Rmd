...
`{bslib}` [@R-bslib] is a package developed by RStudio, built on top `{sass}` providing weapons to deeply customize to your apps, in a ridiculously short amount of time and without too much pain, as shown on Figure \@ref(fig:bslib-motivations).

```{r bslib-motivations, echo=FALSE, fig.cap='Theme preview in action', out.width='100%'}
