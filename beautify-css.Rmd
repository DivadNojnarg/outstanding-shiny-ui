...
Do you remember the `{shinydashboard}` box that we imported inside a simple shiny app in Chapter \@ref(htmldeps-import)? This box has been included in the `{OSUICode}` side package. Let's add it some border and shadows:
