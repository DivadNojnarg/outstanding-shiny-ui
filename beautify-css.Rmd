...
```{r css-layout-intro, echo=FALSE, fig.cap='Inline and block elements', out.width='50%', fig.align="center"}
...
```{r css-block-box, echo=FALSE, fig.cap='Blocks layout', out.width='100%', fig.align="center"}
