...
To understand how Shiny works from inside, especially how inputs are handled, we'll gradually dive into its core which contains a substantial amount of __JavaScript__ (JS).

::: {.warningbox data-latex=""}
This chapter is a very brief introduction to JS and __jQuery__ but still necessary as this book is supposed to be standalone. Advanced JS users may skip this part. If you wish to know more about this language, MDN web docs by Mozilla is an excellent [resource](https://developer.mozilla.org/en-US/docs/Web/JavaScript). 
:::
