...
This chapter is a very brief introduction to JS and jQuery but still necessary as this book is supposed to be standalone. Advanced JS users may skip this part. If you wish to know more about this language, resources like MDN web docs by Mozilla is an excellent [resource](https://developer.mozilla.org/en-US/docs/Web/JavaScript). 
:::
