...
`props` are elements passed to the component (see \@ref(react-map)) and `context` is an object containing [helpers](https://framework7.io/docs/router-component.html#component-context) such as:
  ...
  - `$update` to re-rendered programmatically re-render the component. 
...
```{r vdpMod-basic-app-5, echo=FALSE, fig.cap='vdpMod basic app with time series output and phase portrait', out.width='50%', fig.align='center'}
