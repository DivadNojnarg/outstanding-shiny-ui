...
::: {.noteblock data-latex=""}
The terser concatenates file by alphabetical order (default). 
The __files__ parameters allow you to provide a customized order.
:::

At this point, `{charpente}` does not provide similar process for CSS, as this is still work in progress. 
