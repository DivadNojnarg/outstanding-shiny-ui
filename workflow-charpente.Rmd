...
`{charpente}` points to the CDN without downloading any file. Running that code is faster than the local option but your end users will requires an internet connection to be able to access static assets required by the Shiny app. Therefore, package developers will prefer the `local = TRUE` to ensure dependencies are always accessible.
