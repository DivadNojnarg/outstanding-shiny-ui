...
```{r tabler-github, echo=FALSE, fig.caption='Github project exploration', out.width='100%'}
...
```{r tabler-deps, echo=FALSE, fig.show = "hold", out.width = "50%", fig.align = "default", fig.caption="tabler dependencies overview"}
