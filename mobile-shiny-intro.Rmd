# Introduction
## Case study objectives {#mobile-shiny-intro}
...
learn since the beginning of the book. 
...
The main issue is the need to know multiple languages and maintain multiple
code bases. 

Is there something between pure web apps and native apps? 
