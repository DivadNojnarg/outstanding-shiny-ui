...
In this chapter, I'll demonstrate how we can utilize `{htmltools}` [@R-htmltools] to manage web dependencies, that is handling CSS and JS code as well as other assets in your shiny apps.  You'll realized quickly that it opens the doors to work with almost any web framework, thereby unleashing 
