...
When we run our app, most of the time it works just fine! The question is, what is the magic behind? Upon initialization, Shiny runs several JavaScript functions. Some are accessible to the programmer, through the __Shiny__ JS object, already mentioned in the previous chapter, section \@ref(shiny-js-object). To illustrate what they do, let's run the app below:
