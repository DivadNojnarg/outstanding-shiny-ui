...
Don't forget the `return` statement. Omitting it would simply make the binding step failing, and all other downstream
steps!
:::
...
Shiny.inputBindings.register(myBinding, 'PACKAGE_NAME.BINDING_NAME');
```
...
```js
setValue: function(el, value) {
  let config = $(el).parent().find("script[data-for='" + el.id + "']");
