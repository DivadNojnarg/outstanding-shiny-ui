...
<!-- You're giving the reader a lot of options but at this point have limited ability to discern between them. I think you should give more concrete advice about what to use. And show some examples. -->
...
<!-- Why is that important? How exactly do you check it? -->
...
<!-- What's the advantage of converting HTML to R functions? -->

## Playing with tags

<!-- I think you need some concrete goal to motivate the work below. Can you come up with a use case for why you'd want to do this? -->
...
<!-- Why are these functions important? When would you use them? -->
...
<!-- Could you move this earlier and make it the motivation for the rest of the chapter? -->
