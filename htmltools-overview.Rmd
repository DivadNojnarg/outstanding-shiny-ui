# Mastering {htmltools} {#htmltools-overview}
...
```
You may find another example [here](https://github.com/rstudio/htmltools/blob/master/vignettes/tagQuery.Rmd#L16).
:::
...
The complete code is given in Appendix \@ref(mastering-htmltools-appendix-1), which yields:
...
The complete code may be found in \@ref(mastering-htmltools-appendix-2).
