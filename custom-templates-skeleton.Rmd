...
Each of these element will be considered as an input parameter to the `tabler_header` function, except the first element which is a default element and should not be removed. Morever, we will only show the brand element when it is provided. The ... parameter is a slot for extra elements (between the menu and dropdowns).
...
```{r}
tabler_header <- function(..., brand_url = NULL, brand_image = NULL, nav_menu, nav_right = NULL) {
...
Let's create the navbar menu. The ... parameter is a slot for the menu items. There is nothing else to say about this simple container.
