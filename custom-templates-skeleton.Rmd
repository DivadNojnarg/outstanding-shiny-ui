...
```{r, echo=FALSE, results='asis'}
code_chunk(OSUICode::get_example("tabler/tabler-navbar"), "r")
```
...
```{r, echo=FALSE, results='asis'}
code_chunk(OSUICode::get_example("tabler/tabler-navbar-bis", view_code = FALSE), "r")
```
...
Below, we show an example of the `tabler_card()` function, in combination with the `{apexcharter}` package. The whole code may be printed with `OSUICode::get_example("tabler/tabler-card")`.

```{r, echo=FALSE, results='asis'}
code_chunk(OSUICode::get_example("tabler/tabler-card", view_code = FALSE), "r")
```
...
```{r, echo=FALSE, results='asis'}
code_chunk(OSUICode::get_example("tabler/tabler-ribbon", view_code = FALSE), "r")
```
