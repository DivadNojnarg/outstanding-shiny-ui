...
The result is shown on Figure \@ref(fig:tabler-nav).  We'd also suggest including at least one input/output per tab, to test whether everything works properly. 
