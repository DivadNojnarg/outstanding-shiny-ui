...
#### A chat system for {shinydashboardPlus} {#custpm-handlers-chat-system}
...
Don't forget to __unbind__, re-__initialize__ and __bind__ all inputs by successively calling `Shiny.unbindAll();`, `Shiny.initializeInputs();` and `Shiny.bindAll();`. If you ommit this part, the newly inserted input/output elements won't work! The whole JS code may be found below in appendix \@ref(custom-handlers-chat-appendix)
