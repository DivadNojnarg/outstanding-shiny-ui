...
What we suggest is to extract the most important components as direct `f7_page` parameters and keep less important parameters in the options list. For example, if you think that __theme__ is super important (and it truly is), you could do:
...
with `compress_js` and try with the following app:
...
Let's finish this section by the dark mode. We leverage the Framework7 app method 
