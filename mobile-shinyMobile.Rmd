...
At this point, we can try to run a simple shiny app. Best practice is to save the `app.R` file in
the `inst/examples/simple` folder:
...
To activate that feature, we pass the following list of options to the `f7_page` function:
