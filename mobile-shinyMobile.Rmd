...
The idea is the following:
  ...
  of parameters.
  - We store all list elements in a `data-<ELEMENT_NAME>` non standard attributes in the
  `body` element or at least something that is always in the DOM.
  - We recover those data on the JS side and store them in the app.data object.
...
with the jQuery `find` method (result is commented for convenience):
