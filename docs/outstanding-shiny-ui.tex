...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{/* paired-tags */}
\KeywordTok{<p></p>}
\KeywordTok{<div></div>}

\NormalTok{/* self-closing tags */}
\KeywordTok{<iframe/>}
\KeywordTok{<img/>}
\KeywordTok{<input/>}
\KeywordTok{<br/>}
...
\NormalTok{/* the class awesome-item may be applied to multiple tags */}
...
\KeywordTok{<html>}
  \KeywordTok{<head>}
\NormalTok{  /* head content here */}
  \KeywordTok{</head>}
  \KeywordTok{<body>}
\NormalTok{  /* body content here */}
  \KeywordTok{</body>}
\KeywordTok{</html>}
\end{Highlighting}
\end{Shaded}
