...
\texttt{shinyInputLabel} is an internal function of Shiny that creates the numeric input label, in other word the text displayed next to it. The core input element is wrapped by \texttt{tags\$input}. No worry, we will give more details about shiny tags in the next chapter.
