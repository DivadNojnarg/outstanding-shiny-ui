...
\hypertarget{insertremove-tabs-in-tabsetpanel}{%
\subsection{Insert/Remove tabs in tabsetpanel}\label{insertremove-tabs-in-tabsetpanel}}
...
TO DO: start with a naive approach, show it does not work and introduce \texttt{Shiny.renderContent}, \texttt{processDeps} \ldots{}
