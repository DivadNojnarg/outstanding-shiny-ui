...
Before starting with technical details, we propose to start with a little game. Among all the images shown, what are the one corresponding to shiny apps? Images are numbered from A to F (left to right, top to bottom).
