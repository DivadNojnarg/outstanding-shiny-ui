...
\NormalTok{    tags}\OperatorTok{$}\KeywordTok{style}\NormalTok{(}
      \StringTok{".nav-pills .nav-link.active, .nav-pills .show>.nav-link \{}
\StringTok{        background-color: #a8aeb7;}
\StringTok{      \}}
\StringTok{      "}
\NormalTok{    ),}
  ...
  \KeywordTok{tabler_navbar}\NormalTok{(}
    ...
    \DataTypeTok{nav_menu =} \KeywordTok{tabler_navbar_menu}\NormalTok{(}
      \KeywordTok{tabler_navbar_menu_item}\NormalTok{(}
        \DataTypeTok{text =} \StringTok{"Tab 1"}\NormalTok{,}
        \DataTypeTok{icon =} \OtherTok{NULL}\NormalTok{,}
        \DataTypeTok{tabName =} \StringTok{"tab1"}
\NormalTok{      ),}
      \KeywordTok{tabler_navbar_menu_item}\NormalTok{(}
        \DataTypeTok{text =} \StringTok{"Tab 2"}\NormalTok{,}
        \DataTypeTok{icon =} \OtherTok{NULL}\NormalTok{,}
...
\KeywordTok{<h3}\OtherTok{ class=}\StringTok{"card-title"}\KeywordTok{>}\NormalTok{Card with top status}\KeywordTok{</h3>}
\KeywordTok{<p>}\NormalTok{Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam deleniti fugit incidunt, iste, itaque minima}
\NormalTok{neque pariatur perferendis sed suscipit velit vitae voluptatem.}\KeywordTok{</p>}
\KeywordTok{</div>}
\KeywordTok{</div>}
\KeywordTok{</div>}
\end{Highlighting}
...
\subsubsection{Ribbons: card components}\label{ribbons-card-components}}
...
\NormalTok{my_card}\OperatorTok{$}\NormalTok{children[[}\DecValTok{1}\NormalTok{]] <-}\StringTok{ }\KeywordTok{tagAppendChild}\NormalTok{(my_card}\OperatorTok{$}\NormalTok{children[[}\DecValTok{1}\NormalTok{]], }\KeywordTok{tabler_ribbon}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DataTypeTok{bookmark =} \OtherTok{TRUE}\NormalTok{))}
\NormalTok{my_card}
\end{Highlighting}
\end{Shaded}
