...
\chapter{Shiny, HTML, CSS and JavaScript}\label{shiny-intro}}
...
\chapter{Websocket: R/JS bidirectional communication}\label{shiny-websocket}}
...
\chapter{The Shiny session object}\label{shiny-session}}
