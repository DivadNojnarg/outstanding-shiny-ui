...
\begin{figure}
\includegraphics[width=27.69in]{images/survival-kit/shiny-websocket} \caption{Shiny dependencies}\label{fig:shiny-websocket}
\end{figure}
