...
Below we quickly test if a tabler element renders well to see whether our dependency system is adequately setup. We also ensure that basic Shiny input/output system works as expected by including a sliderInput linked to a plot output.
