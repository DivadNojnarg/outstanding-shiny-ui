...
Fortunately, Shiny provides tools such as `processDeps` (R side) and `Shiny.renderContent` (JS side) to handle newly inserted dependencies, on app runtime.
