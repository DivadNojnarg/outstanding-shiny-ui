...
How to handle custom messages in shiny modules? Well, it is pretty straightforward. We wrap any __id__ with the module __namespace__ given by __session$ns()__ before sending it to JS. You may even do it by default since `session$ns()` returns `""`. 
:::
